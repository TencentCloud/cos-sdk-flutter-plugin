...
- (void)getPresignedUrlServiceKey:(NSString *)serviceKey bucket:(NSString *)bucket cosPath:(NSString *)cosPath signValidTime:(nullable NSNumber *)signValidTime signHost:(nullable NSNumber *)signHost parameters:(nullable NSDictionary<NSString *, NSString *> *)parameters region:(nullable NSString *)region completion:(void(^)(NSString *_Nullable, FlutterError *_Nullable))completion;
